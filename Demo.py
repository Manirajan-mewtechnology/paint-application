...
class WhiteboardApp:
    def __init__(self, root):
        ...
        self.root = root
        self.icon_image = PhotoImage(file='magine.png')
        self.root.iconphoto(False,self.icon_image)
        self.root.title('Imagine')
        ...
        #company logo
        self.logo_image = PhotoImage(file='mew_log_new.png')
        self.logo = tk.Label(root,image=self.logo_image)
        self.logo.place(x=20,y=665)
    ...
    def add_buttons(self):
        # Add buttons for tools
        button_positions = [
            ('Colors','colors1.png',self.select_color),
            (' Pencil', "pencil.png", self.activate_pencil),
            ('Eraser ', "eraser.png", self.toggle_eraser),
            ('Clear  ', "clear.png", self.new_canvas),
            ('upload', "imagefile.png", self.insert_image),
            ('Save   ', "save.png", self.save_image),
            ('BG   ', "background.png", self.change_color)
        ]
